...
- (void)drawRect:(CGRect)rect
{
    ...
    //// label A Drawing
    CGRect textRect = CGRectMake(10, 10, 145, 16);
    [darkGreen setFill];
    [self.comparison.factorA.title drawInRect: textRect withFont: [UIFont fontWithName: @"Helvetica" size: 17] lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentLeft];
    
    
    //// label B Drawing
    CGRect text2Rect = CGRectMake(165, 10, 145, 16);
    [darkOrange setFill];
    [self.comparison.factorB.title drawInRect: text2Rect withFont: [UIFont fontWithName: @"Helvetica" size: 17] lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentRight];
